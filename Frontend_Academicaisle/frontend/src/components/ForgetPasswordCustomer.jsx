...
import img3 from '../images/fpass.jpeg'
...
function ForgetPasswordCustomer() {
    ...
    useEffect(() => {
        ...
        if (Object.keys(errors).length === 0 && submitted) {
            console.log(user)
            axios.post("http://localhost:8080/api/customers/forgetpassword", user)
                .then(resp => {
    ...
    return (
        <div className="container-fluid d-flex justify-content-center align-items-center mt-5 login-component" style={{width: '60%', height: '65vh'}}>
            <div
                className="row shadow bg-white border rounded d-flex align-items-center justify-content-center" style={{height: '60vh', width: '80vw'}}
            >
                <div className="col-4 ">
                    <img
                        src={img3}
                ...
                <div className="col-8">
                    <div className="border border-0 rounded p-2">
                        <h2 className="fw-bold mb-2 mt-2 myheader"> Reset Password</h2>

                        <div className="">
                            <form onSubmit={handleSubmit} sty>
                                ...
                                <button className="btn btn-primary float-center mb-5">Verify Email</button>
                            </form>
