...
function SellerProfile() {
  ...
  return (
    ...
    <div
      className="container mt-1 text-black d-flex justify-content-center align-items-center bg-light"
      style={{ height: "80vh" }}
    >
      <div className="row " style={{ width: "100%" }}>
        <div className="col-sm-7 mx-auto" style={{ width: "100%" }}>
          <div
            className="card shadow bg-transparent mt-3"
            style={{ width: "100%", backgroundColor: "white" }}
          >
            <div className="card-body" style={{ width: "100%" }}>
              <h4 className="p-2 text-center text-dark">Welcome Seller! {uname}</h4>
              <form onSubmit={handleSubmit}>
                <div className="form-group form-row">
                  <label className="col-sm-4 form-control-label">
                    <i className="fa fa-user-circle-o pr-2"></i>Name :
                  </label>
                  <div className="col-sm-8">
                    <input
                      type="text"
                ...
                <div className="form-group form-row">
                  <label className="col-sm-4 form-control-label">
                    <i className="fa fa-address-card pr-2"></i>City :
                  </label>
                  <div className="col-sm-8">
                    <select
                      required
                ...
                <div className="form-group form-row">
                  <label className="col-sm-4 form-control-label">
                    <i className="fa fa-male pr-2"></i>Gender :
                  </label>
                  <div className="col-sm-8">
                    <select
                      required
                ...
                <div className="form-group form-row">
                  <label className="col-sm-4 form-control-label">
                    <i className="fa fa-phone pr-2"></i>Phone :
                  </label>
                  <div className="col-sm-8">
                    <input
                      type="tel"
