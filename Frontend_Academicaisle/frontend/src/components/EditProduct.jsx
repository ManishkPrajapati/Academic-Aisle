                ...
                <div className="card-body">
                    <div className="row">
                        ...
                        <div className="col-sm-6">
                            <h1 className="text-center p-2 myheader">
                                Edit Product :
                            </h1>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-group form-row">
                                    <label className="col-sm-4 form-control-label">Product Type</label>
                                    <div className="col-sm-8">
                                        ...
                                        {errors.type && <medium className="text-danger float-right">{errors.type}</medium>}
                                    </div>
                                </div>

                                <button className="btn btn-danger float-right" onClick={(e) => {navigate("/myProducts")}}>Back</button>
                                <button className="btn btn-primary float-right mr-3" >Update Product</button>
                            </form>
                        </div>
                    </div>
                </div>
