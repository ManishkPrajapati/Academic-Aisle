...
const Feedback = () => {
  ...
  return (
    <div className="container text-black " style={{height: '80vh'}}>
      <div className="row d-flex align-items-center justify-content-center" style={{height: '80v%'}}>
        <div className="col-sm-7 mx-auto">
          <div className="card shadow bg-transparent mt-3">
            <div className="card-body p-8">
              <h1 className="p-2 text-center text-dark myheader">Feedback</h1>
              ...
              <div className="form-group form-row d-flex align-items-center">
                  ...
                  <div className="col-sm-8">
                    <div className="rating" onChange={handleInput}>
